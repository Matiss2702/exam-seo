...
const sections = ref([
  {
    ...
    image: { src: "/terrain confus.webp", alt: "Origines des terrains confus à Paris" },
  },
  {
    id: 2,
    ...
    image: { src: "/terrconfuss.webp", alt: "Transformation industrielle des terrains confus" },
  },
  {
    id: 3,
    ...
    image: { src: "/terrconf.webp", alt: "Réappropriation des terrains confus" },
  },
  {
    id: 4,
    ...
    image: { src: "/terrainconfus.webp", alt: "Développements futurs des terrains confus" },
  },
]);
  ...
  meta: [
    {
      ...
      name: "description",
      content:
        "Découvrez l'histoire et l'évolution des terrains confus à Paris. Explorez comment ces espaces urbains en transition ont reflété les changements économiques et sociaux de la ville au fil du temps.",
    },
    {
      hid: "keywords",
      name: "keywords",
      content:
        "terrain confus, Paris, histoire, évolution, transformation industrielle, réappropriation, développement urbain",
    },
    {
      hid: "og:title",
      property: "og:title",
