...
const sections = ref([
  {
    ...
    image: { src: "/terrain confus.webp", alt: "Pourquoi investir dans les terrains confus à Paris" },
  },
  {
    id: 2,
    ...
    image: { src: "/terrconfuss.webp", alt: "Transformations réussies des terrains confus" },
  },
  {
    id: 3,
    ...
    image: { src: "/terrconf.webp", alt: "Procédures et réglementations pour les terrains confus" },
  },
  {
    id: 4,
    ...
    image: { src: "/terrainconfus.webp", alt: "Perspectives futures des terrains confus" },
  },
]);
  ...
  meta: [
    {
      ...
      name: "description",
      content:
        "Découvrez les opportunités uniques d'investissement dans les terrains confus à Paris. Transformez ces espaces en projets immobiliers prospères et innovants.",
    },
    {
      hid: "keywords",
      name: "keywords",
