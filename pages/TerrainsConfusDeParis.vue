...
const sections = ref([
  ...
  },
  {
    ...
    image: { src: "/terrainconfus.webp", alt: "Un jardin communautaire sur un terrain confus" },
  },
  {
    id: 3,
    ...
    image: { src: "/terrain confus.webp", alt: "La Petite Ceinture à Paris" },
  },
  {
    id: 4,
    ...
    image: { src: "/terrainconfus.webp", alt: "Projet de réhabilitation d'un terrain confus" },
  },
]);
  ...
  meta: [
    {
      ...
      name: "description",
      content:
        "Découvrez les terrains confus de Paris, des espaces urbains uniques en transition qui offrent une perspective fascinante sur la dynamique urbaine et des opportunités de développement.",
    },
    {
      hid: "keywords",
      name: "keywords",
      content:
        "terrain confus, Paris, espaces urbains, réaménagement, friches industrielles, Petite Ceinture, Plaine Saint-Denis",
    },
    {
      hid: "og:title",
      property: "og:title",
